  ...
  return (
    <main className="min-h-screen pb-20 max-w-lg mx-auto">
      <div className="min-h-screen flex flex-col items-center justify-center px-6 bg-[var(--color-bg)]">
        ...
        <button className="w-full max-w-xs flex items-center justify-center gap-3 py-3.5 px-4 rounded-xl bg-[#06C755] text-white font-bold text-sm hover:bg-[#05b04c] transition-colors">
